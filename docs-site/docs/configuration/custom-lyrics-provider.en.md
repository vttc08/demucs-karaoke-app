...
Set `LYRICS_PROVIDER_CUSTOM_PATHS` to a comma-separated list of folders or Python files:
...
For Docker, you must mount your custom provider files into the container and set the `LYRICS_PROVIDER_CUSTOM_PATHS` using container paths.
