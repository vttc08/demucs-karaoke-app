...
def test_media_editor_page_renders_keyframe_timeline(client):
    authenticate_admin_client(client)
    trim_info = {
        "media_id": 42,
        "title": "Test",
        ...
        "has_audio": True,
        "keyframes": [0.0, 10.0, 20.0],
        "vocals_path": "/media/test.vocals.wav",
        "lyrics_path": "/media/test.lrc",
        "lyrics_format": "lrc",
    }
    with patch(
