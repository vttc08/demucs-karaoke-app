...
def test_media_editor_page_renders_loading_shell_without_keyframes_probe(
    ...
    assert 'href="/help/tasks/media-administration/#lossless-trim"' in response.text
    assert response.text.count('href="/help/tasks/media-administration/#lossless-trim"') == 2
